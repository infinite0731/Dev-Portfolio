...
export default function PortfolioCard(props: {
  ...
  return (
    <div className="w-full shadow-custom animate__animated animate__fadeInUp z-[50]">
      <div className="w-full relative h-[24px] bg-[#ddd] text-[#6a6a6a] flex items-center justify-center">
      <div className="w-[230px] overflow-hidden whitespace-nowrap text-sm">
          <h1 className="truncate">{props.siteUrl}</h1>
        </div>
        <i
